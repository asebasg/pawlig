...
Al inicio (justo después de los imports) de cada archivo que contenga lógica de negocio significativa (servicios, componentes complejos, rutas de API), se debe agregar una sección de "Resúmen". Esta sección debe estar comentada y seguir la siguiente plantilla:
