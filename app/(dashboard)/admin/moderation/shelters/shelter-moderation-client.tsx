          ...
          {filteredShelters.map((shelter) => (
            <div key={shelter.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow flex flex-col">
              ...
              <div className="p-4 bg-gray-50 border-t border-gray-100 flex flex-col gap-3">
                ...
                <Link href={`/admin/moderation/users/${shelter.user.id}/view`} passHref className="w-full">
                  <Button 
                    variant="outline" 
 ...
 * - lucide-react: Iconografía unificada (Eye, Check, X, etc.).
 *
 */
