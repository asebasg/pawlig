 ...
 * Requiere: Props de usuario, callbacks onClose y onSuccess.
 * Implementa: Confirmación de acción crítica de seguridad con auditoría.
 */
    ...
    <Dialog open={true} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-lg bg-white">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="bg-gray-50 rounded-lg text-left p-4">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-left w-full">
            <p className="text-sm text-yellow-800 break-words whitespace-normal font-medium">
 ...
 *
 * Descripción General:
 * Este componente es el modal que confirma las acciones de bloqueo y desbloqueo de cuentas.
 *
 * Lógica Clave:
 * - Validación robusta del lado del cliente antes de enviar la solicitud.
 * - Registro en el log de auditoría mediante transacciones de Prisma en la API.
 * - Integración con notificaciones por email al usuario.
 *
 * Dependencias Externas:
 * - Radix UI Dialog para accesibilidad y semántica.
 * - Sonner para toasts de carga, éxito y error.
 *
 */
