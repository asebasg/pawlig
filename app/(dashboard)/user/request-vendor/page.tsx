...
/**
 * PAGE /user/request-vendor
 * Descripción: Página de solicitud de registro como vendedor. Protegida para usuarios autenticados con rol 'ADOPTER'.
 * Requiere: Usuario autenticado, Rol ADOPTER
 * Implementa: Solicitud de Registro de vendedor
 */

export const metadata: Metadata = {
    title: "Solicitar Cuenta de Vendedor",
    description: "Formulario para solicitar el registro de una cuenta de vendedor en PawLig.",
};
...
export default async function RequestVendorPage() {
    ...
    //  1. Validar sesión
    if (!session?.user) {
        redirect('/login?callbackUrl=/user/request-vendor');
    }
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <div className="mb-6 pb-6 border-b border-gray-200">
                        ...
                        <p className="text-gray-600">
                            ...
                            de vendedor. Un administrador revisará tu solicitud en un plazo de 2-3 días laborables.
                        </p>
                                ...
                                <div className="ml-3">
                                    ...
                                    <div className="mt-2 text-sm text-purple-700">
                                        <ul className="list-disc list-inside space-y-1">
                                            <li>Operar en el Valle de Aburrá</li>
 ...
 * de vendedor. Su responsabilidad principal es garantizar que solo los usuarios
