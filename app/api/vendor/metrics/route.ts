 ...
 * Descripción: Obtiene métricas generales de ventas para el vendedor autenticado.
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[GET_VENDOR_METRICS]", error);
    return NextResponse.json(
 ...
 *
 * Descripción General:
 * Endpoint principal para obtener los KPI (ventas totales, tickets, etc.).
 *
 * Lógica Clave:
 * - Valida query params con zod para seguridad y tipos estandarizados.
 *
 */
