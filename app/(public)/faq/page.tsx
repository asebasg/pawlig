    ...
    return (
        <main className="container mx-auto px-4 py-16 max-w-5xl">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-6 mb-12 pb-8 border-b border-slate-100">
                ...
                <div>
                    <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 mb-2">Preguntas Frecuentes</h1>
                ...
                <div className="lg:col-span-3 space-y-12 text-slate-700 leading-relaxed">
                    ...
                    <section id="preguntas-generales" className="scroll-mt-24">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900">I. Preguntas Generales de PawLig</h2>
                        </div>
                        <div className="space-y-6">
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Cómo me registro en la plataforma?</h4>
                            ...
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Cómo puedo subir una mascota para adopción?</h4>
                            ...
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Cómo aplico para adoptar a un animal?</h4>
                             ...
                             <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Puedo comprar productos en la sección veterinaria?</h4>
                            ...
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Qué costo tiene usar PawLig?</h4>
                    ...
                    <section id="sobre-plataforma" className="scroll-mt-24">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900">II. Sobre la Plataforma y el Servicio</h2>
                        </div>
                        <div className="space-y-6">
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Cuál es el rol de PawLig en el proceso de adopción?</h4>
                            ...
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿El proceso de compra de productos es real?</h4>
                    ...
                    <section id="proceso-adopcion" className="scroll-mt-24">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900">III. Proceso de Adopción y Requisitos</h2>
                        </div>
                        <div className="space-y-6">
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿PawLig garantiza que mi solicitud de adopción será aprobada?</h4>
                            ...
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Qué pasa si la mascota adoptada presenta problemas de salud?</h4>
                    ...
                    <section id="gestion-datos" className="scroll-mt-24">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900">IV. Gestión de Datos y Seguridad</h2>
                        </div>
                        <div className="space-y-6">
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Mis datos se comparten o se venden a terceros?</h4>
                            ...
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Cómo puedo ejercer mis derechos sobre mis datos (Habeas Data)?</h4>
                    ...
                    <section id="cuentas-usuario" className="scroll-mt-24">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900">V. Cuentas de Usuario</h2>
                        </div>
                        <div className="space-y-6">
                             <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Qué tan segura es mi sesión?</h4>
                            ...
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Por qué mi cuenta podría ser suspendida o cerrada?</h4>
                    ...
                    <section id="ley-aplicable" className="scroll-mt-24">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900">VI. Ley Aplicable y Modificaciones</h2>
                        </div>
                        <div className="space-y-6">
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h4 className="font-bold text-slate-900 mb-2">¿Cuál es la ley que rige el uso de PawLig?</h4>
