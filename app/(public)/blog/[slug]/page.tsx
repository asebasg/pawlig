  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10 min-h-screen">
      <div className="mt-8">
        ...
        <Link
          href="/blog"
          className="inline-flex items-center gap-2 text-purple-600 hover:text-purple-700 hover:scale-[1.02] active:scale-[0.97] text-sm font-semibold transition duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-600 focus-visible:ring-offset-2 rounded-sm mb-6"
        >
        ...
        {post.tags && post.tags.length > 0 && (
          <div className="flex items-center gap-2 mb-4 overflow-x-auto pb-2 pointer-events-none">
            {post.tags.map((tag, i) => (
              <span
                key={i}
                className="px-3 py-1 bg-purple-50 dark:bg-purple-950/30 text-purple-700 dark:text-purple-400 text-xs rounded-full font-medium whitespace-nowrap"
              >
                {tag}
              </span>
            ))}
      ...
      {relatedPosts.length > 0 && (
        <div className="pt-12 border-t border-zinc-200 dark:border-zinc-800 mt-12">
          <h3 className="text-lg font-medium tracking-tight text-zinc-900 dark:text-zinc-50 mb-6">
