...
export const AVAILABLE_DOCS: DocMetadata[] = [
  { slug: "acta-de-constitucion",    title: "Acta de Constitución",      filePath: "docs/01_Acta_de_Constitucion.md",    category: "analysis" },
  { slug: "stakeholders",            title: "Stakeholders",              filePath: "docs/02_Stakeholders.md",            category: "analysis" },
  { slug: "alcance-del-proyecto",    title: "Alcance del Proyecto",      filePath: "docs/03_Alcance_del_Proyecto.md",    category: "analysis" },
  { slug: "requerimientos",          title: "Requerimientos",            filePath: "docs/04_Requerimientos.md",          category: "analysis" },
  { slug: "historias-de-usuario",    title: "Historias de Usuario",      filePath: "docs/05_Historias_de_Usuario.md",    category: "analysis" },
  { slug: "mapa-de-procesos",        title: "Mapa de Procesos",          filePath: "docs/06_Mapa_de_Procesos.md",        category: "analysis" },
  { slug: "casos-de-uso",            title: "Casos de Uso",              filePath: "docs/07_Casos_de_Uso.md",            category: "analysis" },
  { slug: "arquitectura-software",   title: "Arquitectura de Software",  filePath: "docs/08_Arquitectura_Software.md",   category: "design" },
  { slug: "modelo-entidad-relacion", title: "Modelo Entidad-Relación",   filePath: "docs/09_Modelo_Entidad_Relacion.md", category: "design" },
  { slug: "diagramas-uml",           title: "Diagramas UML",             filePath: "docs/10_Diagramas_UML.md",           category: "design" },
  { slug: "manual-diseno",           title: "Manual de Diseño",          filePath: "docs/11_Manual_Diseño.md",           category: "design" },
  { slug: "plan-de-pruebas",         title: "Plan de Pruebas",           filePath: "docs/12_Plan_de_Pruebas.md",         category: "testing" },
  { slug: "casos-de-prueba",         title: "Casos de Prueba",           filePath: "docs/13_Casos_de_Prueba.md",         category: "testing" },
  { slug: "manual-del-usuario",      title: "Manual del Usuario",        filePath: "docs/14_Manual_del_Usuario.md",      category: "final" },
];
