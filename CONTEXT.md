...
> **Sincronización del esquema de base de datos realizada el 26 de enero de 2025**: Este bloque de código representa una copia exacta y fiel de `prisma/schema.prisma` para asegurar consistencia absoluta con el ORM.
...
> **Mapeo de la estructura de carpetas realizado el 26 de enero de 2025**: Representación jerárquica de todos los archivos y carpetas del repositorio, excluyendo dependencias y compilaciones. Los directorios finalizan siempre con una barra diagonal `/`.
...
> **Análisis de dependencias realizado el 26 de enero de 2025**: Esta sección presenta una categorización exhaustiva y rigurosa de todas las librerías, frameworks y herramientas clave utilizadas en el proyecto (extraídas directamente de `package.json`), organizadas y agrupadas según su propósito técnico específico.
