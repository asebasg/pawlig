...
import AdoptionsSection from "./adoptions-section";
...
export default function AdopterDashboardClient({
  ...
  const initialTab =
    (searchParams.get("tab") as "adoptions" | "favorites" | "cart") ||
    "adoptions";
  const [activeTab, setActiveTab] = useState<
    "adoptions" | "favorites" | "cart"
  >(initialTab);

  // Sincronizar el tab activo con el parámetro de la URL
  React.useEffect(() => {
    const tab = searchParams.get("tab") as "adoptions" | "favorites" | "cart";
    if (tab && (tab === "adoptions" || tab === "favorites" || tab === "cart")) {
      setActiveTab(tab);
    }
  }, [searchParams]);
    ...
    <div className="w-full">
      ...
      <div className="flex gap-2 mb-8 border-b border-gray-200">
        <button
          ...
          className={`flex flex-inline px-4 py-3 font-medium transition border-b-2 ${
            activeTab === "adoptions"
      ...
      <div className="animate-in fade-in duration-200">
        {activeTab === "adoptions" && <AdoptionsSection />}
