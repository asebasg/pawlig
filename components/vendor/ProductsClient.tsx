                ...
                <div>
                    ...
                    <div className="mt-3">
                        <span className="text-sm text-gray-500">
                            Mostrando <span className="font-semibold text-gray-900">{products.length}</span> de <span className="font-semibold text-gray-900">{dynamicCounts.all}</span> productos
                            {searchQuery.trim() && (
...
function FilterButton({
    ...
    return (
        ...
        >
            ...
            <span className={`text-xs ml-1 px-1.5 py-0.5 rounded-full ${active ? "bg-white/20" : "bg-purple-200/50"}`}>
                {count}
            </span>
        </Link>
    );
