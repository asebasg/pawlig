...
¡Bienvenido a **PawLig**! La plataforma web integral para la adopción responsable de mascotas y comercio electrónico de productos para animales en el **Valle de Aburrá**.

PawLig conecta a albergues, adoptantes, vendedores y la comunidad en un solo espacio digital, facilitando el proceso de adopción y el acceso a productos de calidad para el cuidado animal.

**Nuestra misión**: Promover la adopción responsable, reducir el abandono animal y fortalecer la relación entre los albergues y las familias que buscan dar un hogar a mascotas en el Valle de Aburrá.

### 1.2. Propósito del manual

Este manual proporciona una guía completa para utilizar todas las funcionalidades de PawLig. Encontrará instrucciones paso a paso, capturas de pantalla ilustrativas y soluciones a problemas comunes.

### 1.3. Audiencia

Este manual está dirigido a:

1. 🐾 **Adoptantes**: Personas que buscan adoptar una mascota
2. 🏠 **Albergues**: Entidades de rescate animal que publican mascotas
3. 🛒 **Vendedores**: Proveedores de productos para mascotas
4. ⚙ **Administradores**: Personal encargado de supervisar el sistema

### 1.4. Convenciones del documento

A lo largo de este manual utilizaremos las siguientes convenciones:

- 💡 **NOTA**: Información adicional importante
- ⚠ **ADVERTENCIA**: Precaución sobre posibles problemas
- ✅ **CONSEJO**: Recomendaciones para mejor experiencia
- 📸 **[Captura de pantalla]**: Indica ubicación de imagen ilustrativa
...
Para utilizar PawLig de manera óptima, su dispositivo debe cumplir con:

| COMPONENTE             | REQUISITO MÍNIMO                                                            |
| ---------------------- | --------------------------------------------------------------------------- |
| Sistema Operativo      | Windows 10+, macOS 10.14+, Linux Ubuntu 20.04+, iOS 14+, Android 10+        |
| Memoria RAM            | 4 GB mínimo (8 GB recomendado)                                              |
| Resolución de Pantalla | Mínimo 320px de ancho (móvil). Recomendado: 1366×768px o superior (desktop) |
| Conexión a Internet    | Banda ancha 10 Mbps o superior. Conexión estable requerida                  |

### 2.2. Navegadores compatibles

PawLig es compatible con las siguientes versiones de navegadores:
...
⚠ **ADVERTENCIA**: Navegadores antiguos o no actualizados pueden presentar problemas de visualización o funcionalidad.
...
✅ **CONSEJO**: Para una experiencia óptima en tareas administrativas (publicar mascotas, gestionar inventario), recomendamos usar dispositivos desktop o tablets.

### 2.4. Conexión a internet

Se requiere conexión activa a internet para:

- Acceder a la plataforma
- Visualizar imágenes de mascotas y productos
- Enviar y recibir notificaciones
- Sincronizar datos en tiempo real

💡 **NOTA**: PawLig **NO** funciona sin conexión (offline).
...
Para acceder a PawLig, abra su navegador web e ingrese a:

🌐 **<https://pawlig.vercel.app>**

💡 **NOTA**: Se recomienda agregar esta URL a sus marcadores o favoritos para acceso rápido.
...
- **Paso 1**: Haga clic en su nombre o foto de perfil en la esquina superior derecha.
- **Paso 2**: Seleccione **"Cerrar Sesión"** del menú desplegable.
- **Paso 3**: Su sesión se cerrará y será redirigido a la página de inicio.

✅ **CONSEJO**: Siempre cierre sesión cuando use computadoras compartidas o públicas.
...
Una vez iniciada la sesión, accederá a su panel personal donde podrá:

- Ver sus mascotas favoritas
- Seguir el estado de sus postulaciones de adopción
- Acceder a su historial de compras
- Actualizar su perfil

Para acceder al panel en cualquier momento, haga clic en **"Mi Panel"** en el menú de navegación.
...
- Edad aproximada
- Sexo
- Descripción completa del carácter y personalidad
- Requisitos para adopción
- Estado de salud (vacunas, esterilización)
- Información del albergue
- Municipio de ubicación

**Paso 3**: Desde esta página puede:

- Guardar como favorita (ícono de corazón)
- Postularse para adopción
- Contactar al albergue
...
**Paso 3**: Use los filtros para refinar su búsqueda:
...
**Paso 4**: Haga clic en cualquier producto para ver:
...
⚠ **IMPORTANTE**: PawLig simula el proceso de compra con fines demostrativos. **NO** se procesarán pagos reales.
...
**Paso 3**: Seleccione un método de pago simulado:

- Transferencia bancaria
- Pago contra entrega
- Tarjeta de crédito (simulado)

**Paso 4**: Revise el resumen de su pedido:
...
- Actualiza el inventario (descuenta stock)
- Notifica al vendedor
- Muestra página de confirmación

**Paso 7**: Recibirá un correo electrónico con:

- Número de orden
- Detalles de los productos
- Información del vendedor para coordinar entrega

💡 **NOTA**: El vendedor se comunicará con usted para coordinar la entrega y el pago real fuera de la plataforma.
...
Una vez aprobado, accederá a su panel especializado:

Desde el panel puede:

- Publicar mascotas para adopción
- Ver y editar mascotas publicadas
- Gestionar postulaciones de adoptantes
- Generar reportes de adopciones
- Actualizar perfil y métodos de contacto
...
- Nombre de la mascota
- Especie (Perro, Gato, Otro)
- Raza (puede escribir "Cruce" o "Desconocida")
- Edad aproximada (años)
- Sexo (Macho, Hembra)

**DESCRIPCIÓN**:

- Descripción detallada del carácter, personalidad y comportamiento
- Mínimo 20 caracteres, máximo 500

**REQUISITOS**:

- Requisitos específicos para adopción (espacio, experiencia, otras mascotas, etc.)
- Este campo es opcional pero recomendado

**ESTADO DE SALUD**:

- Indique si está vacunado
- Indique si está esterilizado
- Mencione cualquier condición médica especial

**FOTOS**:

- Suba al menos **1 foto (obligatorio)**
- Se recomiendan **3–5 fotos** de calidad
...
- Crea la publicación con estado **"Disponible"**
...
Las mascotas pueden tener tres estados:

- 🟢 **Disponible**: Lista para adopción
- 🟡 **En Proceso**: Con postulación en revisión o aprobada
- ⚫ **Adoptada**: Ya tiene hogar definitivo
...
- **"En Proceso"** o **"Adoptada"**: Se oculta de búsquedas públicas

⚠ **ADVERTENCIA**: Solo cambie el estado a **"Adoptada"** cuando la adopción esté completamente finalizada.
...
- Mensaje enviado por el adoptante
- Fecha de postulación

**Paso 5**: Desde aquí puede:

- Aprobar la postulación
- Rechazar la postulación
- Contactar al adoptante vía WhatsApp
...
- Envía notificación por email al adoptante
- Muestra los datos de contacto del adoptante
...
Una vez aprobado, accederá a su panel de vendedor. Desde aquí puede:

- Agregar productos al catálogo
- Gestionar inventario (stock)
- Ver órdenes de compra recibidas
...
- Nombre del producto
- Categoría (Alimento perros, Alimento gatos, Accesorios, Juguetes, etc.)
- Precio (en pesos colombianos)
- Stock disponible (cantidad en unidades)

**DESCRIPCIÓN**:

- Descripción detallada del producto
- Características principales
- Información de uso o dosificación (si aplica)
- Mínimo 20 caracteres

**IMÁGENES**:

- Suba al menos **1 foto** del producto
- Se recomiendan **2–3 fotos** (diferentes ángulos)
- Formatos: JPEG, PNG
...
**Paso 3**: Haga clic en **"Ver Detalles"** para información completa:
...
**Paso 4**: Para actualizar el estado de una orden:

- Haga clic en el dropdown **"Estado"**
- Seleccione el nuevo estado
- Haga clic en **"Guardar"**

**Paso 5**: El cliente recibirá notificación por email del cambio de estado.

💡 **NOTA**: Use el teléfono del cliente para coordinar la entrega y el pago real fuera de la plataforma.
...
**Paso 5**: Para exportar, haga clic en **"Descargar Excel"**.

✅ **CONSEJO**: Use estos reportes para análisis de inventario y toma de decisiones de negocio.
...
- Aprobar/rechazar solicitudes de albergues
...
- Nombre
- Email
- Rol (Adoptante, Albergue, Vendedor, Admin)
- Fecha de registro
- Estado (Activo, Bloqueado)

**Paso 3**: Use los filtros para buscar:
...
- Ver actividad (mascotas publicadas, postulaciones, compras)
- Cambiar rol
...
- Confirme la acción
- El sistema envía email de aprobación al solicitante
- El albergue puede acceder inmediatamente

**Paso 6**: Para **RECHAZAR**:

- Haga clic en **"Rechazar"**
- Ingrese un motivo claro y profesional
- Confirme el rechazo
- El sistema envía email con el motivo

✅ **CONSEJO**: Verifique que el albergue sea una entidad legítima. Puede buscar su NIT en registros públicos o solicitar documentación adicional.
...
- Desactiva la cuenta
- Oculta todas sus publicaciones (mascotas/productos)
- Registra el motivo con auditoría
...
**Paso 1**: En el panel administrativo, la página principal muestra el dashboard.

**Métricas disponibles**:

- Total de usuarios registrados
- Total de albergues activos
...
**Paso 2**: Use los filtros para segmentar por:

- Rango de fechas
- Municipio específico
- Tipo de usuario

✅ **CONSEJO**: Exporte estos datos para presentaciones o informes institucionales.
...
- Ingrese el nombre (ej. _"Camas y Colchonetas"_)
...
**Paso 5**: Para **ELIMINAR**:

- Haga clic en el ícono de eliminar
- ⚠ El sistema advertirá si hay productos usando esa categoría
- Debe reasignar productos antes de eliminar
...
| PROBLEMA                           | SOLUCIONES                                                     |
| ---------------------------------- | -------------------------------------------------------------- |
| No puedo iniciar sesión            | ✓ Verifique que su email y contraseña sean correctos           |
|                                    | ✓ Asegúrese de que su cuenta no esté bloqueada                 |
|                                    | ✓ Intente recuperar su contraseña                              |
|                                    | ✓ Limpie caché y cookies del navegador                         |
|                                    | ✓ Intente desde otro navegador o dispositivo                   |
| Mi cuenta fue bloqueada            | ✓ Revise el correo de notificación con el motivo del bloqueo   |
|                                    | ✓ Contacte a soporte: <soporte@pawlig.com>                     |
|                                    | ✓ No cree cuentas duplicadas (resultará en bloqueo permanente) |
| No recibí el email de recuperación | ✓ Revise la carpeta de spam o correo no deseado                |
|                                    | ✓ Espere hasta 10 minutos (puede haber demora)                 |
|                                    | ✓ Verifique que el email ingresado sea el correcto             |
|                                    | ✓ Intente nuevamente desde la página de recuperación           |
|                                    | ✓ Contacte a soporte si persiste el problema                   |

### 8.2. Problemas con imágenes

| PROBLEMA                                       | SOLUCIONES                                            |
| ---------------------------------------------- | ----------------------------------------------------- |
| No puedo subir fotos de mascotas/productos     | ✓ Verifique que el formato sea JPEG o PNG             |
|                                                | ✓ Verifique que cada imagen sea menor a 5 MB          |
|                                                | ✓ Intente con imágenes de menor tamaño                |
|                                                | ✓ Use herramientas de compresión de imágenes          |
|                                                | ✓ Intente desde otro dispositivo o navegador          |
| Las imágenes se ven borrosas o de mala calidad | ✓ Suba imágenes de alta resolución (mínimo 800×600px) |
|                                                | ✓ No use capturas de pantalla de baja calidad         |
|                                                | ✓ Tome fotos con buena iluminación                    |
|                                                | ✓ Evite zoom digital excesivo                         |

### 8.3. Problemas con el carrito

| PROBLEMA                              | SOLUCIONES                                                        |
| ------------------------------------- | ----------------------------------------------------------------- |
| No puedo agregar productos al carrito | ✓ Verifique que el producto tenga stock disponible                |
|                                       | ✓ Asegúrese de haber iniciado sesión                              |
|                                       | ✓ Limpie caché del navegador                                      |
|                                       | ✓ Intente agregar desde la página de detalles del producto        |
| Los productos desaparecen del carrito | ✓ El carrito se limpia al cerrar sesión (comportamiento esperado) |
|                                       | ✓ El carrito expira después de 24 horas de inactividad            |
|                                       | ✓ Si el stock se agota, el producto se elimina automáticamente    |
|                                       | ✓ Complete su compra antes de cerrar sesión (recomendación)       |

### 8.4. Problemas de rendimiento

| PROBLEMA                      | SOLUCIONES                                                              |
| ----------------------------- | ----------------------------------------------------------------------- |
| El sitio carga muy lento      | ✓ Verifique su conexión a internet (mínimo 10 Mbps)                     |
|                               | ✓ Cierre otras pestañas del navegador                                   |
|                               | ✓ Limpie caché y cookies                                                |
|                               | ✓ Actualice su navegador a la última versión                            |
|                               | ✓ Intente en horarios de menor tráfico                                  |
| Las imágenes tardan en cargar | ✓ Esto es normal con conexiones lentas (explicación del comportamiento) |
|                               | ✓ Espere unos segundos, las imágenes se optimizan automáticamente       |
|                               | ✓ Use conexión WiFi en lugar de datos móviles                           |

### 8.5. Errores comunes

| ERROR                                 | SOLUCIÓN / EXPLICACIÓN                                                                                |
| ------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| "Este email ya está registrado"       | Use otro email o recupere su contraseña si olvidó sus credenciales.                                   |
| "Contraseña muy corta"                | Use al menos 8 caracteres con mayúsculas, minúsculas y números (cumpliendo la política de seguridad). |
| "Mascota no disponible"               | La mascota ya fue adoptada o el albergue cambió su estado.                                            |
| "Producto sin stock"                  | El producto se agotó. Intente más tarde o busque alternativas.                                        |
| "No tienes permisos para esta acción" | Su cuenta no tiene los permisos necesarios. Verifique su rol o contacte a un administrador.           |
...
**Sede**: Servicio Nacional de Aprendizaje – SENA Medellín, Antioquia, Colombia

**Equipo de desarrollo**:

- Andrés Sebastián Ospina Guzmán (Líder)
- Mateo Úsuga Vasco (Desarrollador)
- Santiago Lezcano Escobar (Diseñador y Tester)

**Instructor**: Mateo Arroyave Quintero

**Portal de ayuda**: <https://pawlig.vercel.app/ayuda> (próximamente)

**Redes sociales**:

- Instagram: @pawlig_oficial (próximamente)
- Facebook: PawLig Valle de Aburrá (próximamente)
...
| Valle de Aburrá      | Región metropolitana compuesta por 10 municipios: Medellín, Bello, Itagüí, Envigado, Sabaneta, La Estrella, Caldas, Copacabana, Girardota y Barbosa. |
